...
var WebSocketRC = function (_React$Component) {
    ...
    function WebSocketRC(props) {
        ...
        _this.handleMessage = function (_ref) {
            ...
            try {
                ...
                var result = { rawText: data };
                _this.props.onMessage(result);
            }
        };

        _this.closeOldSocket = function () {
            if (_this.ws && _this.ws.readyState === ws.CONNECTING) {
    ...
    _createClass(WebSocketRC, [{
        ...
        value: function initWebSocket() {
            ...
            ws.onclose = function () {
                console.log(_this2.retryTimes);
                if (_this2.shouldClose || _this2.retryTimes++ > (_this2.props.maxRetryTimes || 3)) {
                    _this2.props.onClose();
                    return;
                }
                _this2.props.onRetry && _this2.props.onRetry();
                setTimeout(function () {
                    _this2.initWebSocket();
                }, _this2.props.retryDelay || 3000);
            };
...
WebSocketRC.propTypes = {
    ...
    actionMap: _propTypes2.default.object,
    actionKey: _propTypes2.default.string,
    autoReconnect: _propTypes2.default.bool,
    maxRetryTimes: _propTypes2.default.number,
    retryDelay: _propTypes2.default.number
};
